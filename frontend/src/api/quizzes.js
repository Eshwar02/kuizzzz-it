...
export const quizzesApi = {
  list: (params = {}) => api.get("/quizzes", { params }).then((r) => r.data), // {category_id?,search?,difficulty?,max_duration?,sort?,mine?}
  ...
  getAssignments: (id) => api.get(`/quizzes/${id}/assignments`).then((r) => r.data),
  setAssignments: (id, payload) => api.put(`/quizzes/${id}/assignments`, payload).then((r) => r.data),
};
